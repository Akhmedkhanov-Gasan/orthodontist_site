# Generated by Django 5.1.1 on 2024-09-27 07:18
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to="static/patient_photos/",
                        verbose_name="Фотографии",
                    ),
                ),
                (
                    "general_info",
                    models.TextField(verbose_name="Общая информация о пациенте"),
                ),
                (
                    "treatment_type",
                    models.CharField(
                ...
                (
                    "last_visit_date",
                    models.DateField(verbose_name="Дата последнего визита"),
                ),
                (
                    "next_visit_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Следующий визит"
                    ),
                ),
                (
                    "notes",
                    models.TextField(
                        blank=True, null=True, verbose_name="Комментарии врача"
                    ),
                ),
                (
                    "cost_of_treatment",
                    models.DecimalField(
                        ...
                        max_digits=10,
                        null=True,
                        verbose_name="Стоимость лечения",
                    ),
                ),
            ],
        ),
